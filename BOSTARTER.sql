...
create table FOTO(
    ...
    PRIMARY KEY (nomeProgetto, foto(255)),
...
create table CANDIDATURA(
    ...
    -- emailCreatoreProgetto varchar(40),
	foreign key (emailUtente) references UTENTE(email) on delete cascade,
	foreign key (nomeProfilo, nomeProgettoSoftware) references PROFILO(nome, nomeProgettoSoftware) on delete cascade,
...
DELIMITER $
create procedure InserisciReward(descrizione varchar(300), foto longblob, nomeProgetto varchar(30))
begin
